# genpark-browser-computer-use-element-anchor-skill
...
result = client.anchor_interactive_element()
print(result)
```
...
```json
{
  "mcpServers": {
    "genpark-browser-computer-use-element-anchor-skill": {
      "command": "python",
      "args": ["/path/to/genpark-browser-computer-use-element-anchor-skill/mcp_server.py"]
    }
  }
}
```
